...
Automates UG1787 (Board Setup) for VEK385 Rev-A/Rev-B.
...
# Vivado 2026.1+ (required -- provides XSDB)
...
./vek385-flash-ospi.exp \
  --vivado-dir /tools/Xilinx/Vivado/2026.1 \
  --boot-images /path/to/boot_images \
  --dry-run

# Full run with env var
export VIVADO_INSTALL_DIR=/tools/Xilinx/Vivado/2026.1
