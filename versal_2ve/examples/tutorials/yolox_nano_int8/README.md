...
This tutorial demonstrates **YOLOX-Nano INT8 model inference and NPU power measurement** on the AMD Versal AI Edge Series Gen 2 VEK385 Evaluation Kit using Vitis AI.
...
Run the conversion inside the Vitis AI Docker:
...
Run inside the Vitis AI Docker:
...
- **Output Format:** CSV file written to `/tmp/` with timestamp (example: `pmtool_<timestamp>.csv`)
...
| ------------------- | ------------------- | ------------------- | ------------------- | ------------------- | ------------------ |
| <timestamp>         | 0.648               | 0.701               | 0.669               | 0.722               | **2.740**          |
| <timestamp>         | 0.652               | 0.706               | 0.676               | 0.737               | **2.771**          |
| ...                 | ...                 | ...                 | ...                 | ...                 | ...                |
| <timestamp>         | 0.097               | 0.167               | 0.169               | 0.147               | **0.580**          |
| <timestamp>         | 0.100               | 0.173               | 0.161               | 0.133               | **0.567**          |
| <timestamp>         | 0.635               | 1.099               | 0.674               | 0.730               | **3.138**          |
| <timestamp>         | 0.634               | 0.686               | 0.667               | 0.725               | **2.712**          |
