...
This document describes how to quantize, compile, and execute a mixed precision model (INT8 head, BF16/FP16 tail) using the `x_plus_ml_vart` application on AMD Versal™ AI Edge Series Gen 2 with Vitis AI.
...
- **Vitis AI Docker for Versal AI Edge Series Gen 2** – for model quantization and compilation
